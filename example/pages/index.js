import { useFloatingScrollbar } from '../../floating-scrollbar';

import { toCamel } from '../lib/util';

import hookConfig from '../../floating-scrollbar/package.json';
...
export default function Index() {
  ...
  const { message } = useFloatingScrollbar(hookSettings);
